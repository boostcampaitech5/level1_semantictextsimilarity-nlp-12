...
class Model(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        if args.pool_special_linear:
            ...
            logits_1 = self.pool_special_linear_layer(
            ...
            if args.S_swap:
                ...
                logits_2 = self.pool_special_linear_layer(
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if args.pool_special_linear:
            ...
            logits = self.pool_special_linear_layer(special_hidden_states).unsqueeze(1)
    ...
    def predict_step(self, batch, batch_idx):
        ...
        del hidden_states_2
        return (
            ((logits_1 + logits_2) * 0.5).squeeze()
            if args.S_swap
            else logits_1.squeeze()
        )
...
if __name__ == "__main__":
    ...
    #     L1Loss=args.L1Loss,
    #     penalty_zero=args.penalty_zero,
    #     R_drop_alpha=args.R_drop_alpha,
    # )
    # checkpoint = torch.load(
    #     "./klue_roberta-large/di9nsd9i/checkpoints/epoch=7-step=4608.ckpt"
    # )
    # model.load_state_dict(checkpoint["state_dict"])

    # # pt 버전
    model = torch.load(
        "snunlp-KR-ELECTRA-discriminator-directpt_Sswap_Rdrop_special_voting_penalty37_vanilatrain.pt"
    )
    ...
    output.to_csv(
        "snunlp-KR-ELECTRA-discriminator-directpt_Sswap_Rdrop_special_voting_penalty37_vanilatrain_onlylogit1.csv",
        index=False,
    )
